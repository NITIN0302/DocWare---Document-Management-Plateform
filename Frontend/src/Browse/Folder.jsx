...
//     //             {ele.freeze == 0 ? (
//     //               <FontAwesomeIcon
//     //                 className="shadow-xl text-sm text-green-500 p-1 rounded-md"
//     //                 onClick={() => {
...
//     //             ) : (
//     //               <FontAwesomeIcon
//     //                 className="shadow-xl text-sm text-red-500 p-1 rounded-md"
//     //                 onClick={() => {
//     //                   freezeFolder(ele.uuid);
//     //                 }}
//     //                 icon={faLock}
...
//         Showing {folderData.length} item{folderData.length !== 1 && "s"}
//       </div>
//     </div>
//   );
// };
